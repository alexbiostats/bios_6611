...
reg_topics_desc <- c('An approach to evaluating either multiple hypotheses simultaneously or to more easily test combinations of covariates.',
                     ...
                     'Various approaches to selection the "best" or "optimal" model are presented including the coefficient of determination, F-tests, model selection criterion (AIC, BIC), and Mallows\' Cp. All subsets regression is illustrated across these various measures.',
...
mat_reg_videos <- c(paste0('[YouTube](',mat_reg_videos_link,')'), '--') #need to add video once done
