...
## Page Limits
**Simulation studies** have an expected page length of approximately two pages. 

**Brief reports** have an expected page length of approximately three pages. 

These pages limits include figures and tables, but not references. 
...
**Brief reports** must include a "Table 1" that describes the study population. Additional tables may be included as necessary to present and summarize results.

**Brief reports** and **simulation studies** must both include *at least one* figure to describe the data and/or results. Additional figures are welcomed to describe the data and/or results where appropriate.
...
Given the small page limits, it is acceptable to include additional tables and figures in a Supplemental Materials section if needed. These figures and tables should be referenced in the text as **Figure S1**, **Table S1**, etc. 
